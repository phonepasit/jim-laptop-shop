    ...
    <div class="container py-4">
        <div class="card-user-create row bg-white" style="border-radius: 1rem">
            <div class="table-header d-flex justify-content-between py-3">
                <h4 class="m-0 align-self-center fw-bold">Add User</h4>
            </div>
            <div class="py-3 px-5">
                <form action="{{ route('admin.user.store') }}" method="POST">
                    ...
                    <div class="mb-3 row justify-content-center">
                        ...
                        <div class="col-sm-6">
                            <input type="date" class="form-control" id="date" name="date" placeholder="Please Enter Date Of Birth...">
                            @if ($errors->has('date'))
                    ...
                    <div class="mb-3 row justify-content-center">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="district" name="district" placeholder="Please Enter District...">
                    ...
                    <div class="mb-3 row justify-content-center">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="ward" name="ward" placeholder="Please Enter Ward...">
                            @if ($errors->has('ward'))
                    ...
                    <div class="mb-3 row justify-content-center">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="province" name="province" placeholder="Please Enter Province...">
                    ...
                    <div class="mb-3 mt-5 row d-flex">
                        ...
                        <div class="col-sm offset-sm-2">
                            <button type="submit" class="btn btn-dark text-white">Add User</button>
                        </div>
                    </div>
                </form>
            </div>
