...
<div class="container py-4">
    <div class="card-category-edit row bg-white" style="border-radius: 1rem">
        <div class="table-header d-flex justify-content-between py-3">
            <h4 class="m-0 align-self-center fw-bold">Edit Category</h4>
        </div>
        <div class="py-3 px-5">
    <form action="{{ route('admin.category.update', ['id' => $category->id]) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3 mt-5 row d-flex">
            <div class="col-sm offset-sm-2">
                <a href="{{ route('admin.category.index') }}" class="btn border">Trở lại</a>
            </div>

            <div class="col-sm offset-sm-2">
                <button type="submit" class="btn btn-dark text-white">Chỉnh sửa Category</button>
            </div>
        </div>
    </form>
@endsection
